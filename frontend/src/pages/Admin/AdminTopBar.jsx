...
function AdminTopBar({ bgColor = "bg-white" }) {
  return (
    <div className="sticky top-0 bg-green-600 text-white items-center duration-500 flex justify-between pl-1 pr-4 lg:pl-4 lg:pr-16 py-2">
